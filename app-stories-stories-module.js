...
var StoriesComponent = /** @class */ (function () {
    ...
    StoriesComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route.params.subscribe(function (params) {
            _this.post = 'assets/blog/posts/' + params['id1'] + '.md';
        });
        ...
        this.markdownService.getSource('assets/blog/posts/test3.md').subscribe(function (data) {
